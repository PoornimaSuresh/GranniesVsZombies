...
public class zombie : MonoBehaviour
{
	...
	void Start()
	{
		...
		enemy = GameObject.FindGameObjectsWithTag("granny");
	...
	void Update()
	{
		...
		if (countManager.num_grannies > 0)
		{
	...
	void Attack()
	{
		...
		{
			nearestEnemy.GetComponent<Granny>().InflictDamage(damage);
		}
